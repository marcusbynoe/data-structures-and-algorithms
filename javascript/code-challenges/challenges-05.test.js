...
const addValues = (arr) => {
  // Solution code here...
  return arr.reduce((value, num) => value + num, 0);
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((item, obj) => item + obj.purchasePrice, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((names, vader) => names = [...names, vader.name], []);
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
...
const reversedString = (str) => {
  ...
  return strArray.reduce((string, newString) => `${newString}${string}`, '');
};
